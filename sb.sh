...
curl -sL https://raw.githubusercontent.com/jingjie1135/sing-box-yg/main/version | awk -F "更新内容" '{print $1}' | head -n 1 > /etc/s-box/v
red "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
lnsb(){
rm -rf /usr/bin/sb
curl -L -o /usr/bin/sb -# --retry 2 --insecure https://raw.githubusercontent.com/jingjie1135/sing-box-yg/main/sb.sh
chmod +x /usr/bin/sb
}
...
service iptables save >/dev/null 2>&1
green "Sing-box卸载完成！"
blue "欢迎继续使用Sing-box-yg脚本：bash <(curl -Ls https://raw.githubusercontent.com/jingjie1135/sing-box-yg/main/sb.sh)"
echo
}
...
curl -L -o /etc/s-box/sbwpph -# --retry 2 --insecure https://raw.githubusercontent.com/jingjie1135/sing-box-yg/main/sbwpph_$cpu
...
latestV=$(curl -sL https://raw.githubusercontent.com/jingjie1135/sing-box-yg/main/version | awk -F "更新内容" '{print $1}' | head -n 1)
...
echo -e "${yellow}$(curl -sL https://raw.githubusercontent.com/jingjie1135/sing-box-yg/main/version)${plain}"
fi
else
